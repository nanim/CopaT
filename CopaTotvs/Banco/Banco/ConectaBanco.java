...
public class ConectaBanco {
	 ...
	 * @return <i>true</i> - Para conexão que se abrir corretamente
	 * <br>
	 * <i>false</i> - Para abertura de conexão que falhar. 
	 */
	...
	/**
	 * @author Fellipe/Tiago
	 * @return <i>true</i> - Para conexão que se fecha corretamente
	 * <br>
	 * <i>false</i> - Para fechamento de conexão que falhar. 
	 */
